...
public class Mat // simple matrix class for homogeneous operations
{
    ...
    /// Open the RoboDK.cs file and comment/uncomment the prefered Euler Convention
    /// </summary>
    /// <param name="x"></param>
    /// <param name="y"></param>
    /// <param name="z"></param>
    ...
    static public Mat FromTxyzRxyz(double x, double y, double z, double rx, double ry, double rz)
    {
        ...
        //Rot[X,Y,Z] Convention
        return new Mat(crz * cry, crz * sry * srx - srz * crx, crz * sry * crx + srz * srx, x, srz * cry, srz * sry * srx + crz * crx, srz * sry * crx - crz * srx, y, -sry, cry * srx, cry * crx, z);
    }
...
public class RoboDK
{
    ...
    /// <summary>
    /// Adds a point providing its coordinates. The provided points must be a list of vertices. A vertex normal can be provided optionally.
    /// </summary>
